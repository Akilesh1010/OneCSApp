...
public class FileManager {
	...
	public static void fileUploadUsingAutoIt(String absoluteFilePath) throws IOException {
		/*wrapping filePath into double quote to over come space in between directory or file name*/
		...
		//doesn't work
		//Runtime.getRuntime().exec("./src/main/resources/exes/FileUpload(x64).exe"+" "+parent+" "+fileName);
		
		List<String> cmds =  Arrays.asList("cmd.exe","/C","start","./src/main/resources/exes/FileUpload(x64).exe",parent,fileName);
